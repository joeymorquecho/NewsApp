//
//  MainArticlesCollectionViewCell.swift
//  yourNYTimes
//
...
// MainArticlesCollectionViewCell is in a collection view in PersonalNewsViewController.
class MainArticlesCollectionViewCell: UICollectionViewCell {
